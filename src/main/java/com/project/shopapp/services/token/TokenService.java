...
//         Token amount exceed limited, Deleted a old token
        if (tokenCount >= MAX_TOKENS) {
            //Check list Usertoken exist
            //one token non mobile (non-mobile)
            ...
            if (hasNonMobileToken) {
                ...
                //It's all token about mobile
                //Delete the first token in the list
